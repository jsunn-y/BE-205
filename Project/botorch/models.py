...
class BaseModel:
    ...
    def train(self, num_iter: int, lr, train=None, verbose=True, track_lc=False):
        ...
        # TODO: if GP, aux is likelihood, else, ...?
        # One call to train_model(), which is defined for each model in networks.py
        model, likelihood = tmodel.train_model(ttrain_x, ttrain_y, lr, num_iter, aux=tlikelihood)
